...
// import { MessageSquare, X } from 'lucide-react'; // Make sure you have lucide-react installed

// const ChatBot = () => {
//   const [messages, setMessages] = useState<{ text: string; sender: 'user' | 'bot' }[]>([]);
//   const [input, setInput] = useState('');
//   const [isOpen, setIsOpen] = useState(false); // New state to manage visibility
...
//       {isOpen && (
//         <div className="max-w-md w-80 fixed bottom-20 right-4 bg-white shadow-lg p-4 rounded-lg flex flex-col h-[60vh]">
